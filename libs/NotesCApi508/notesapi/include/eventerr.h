...
#define TASK_NAME_STRINGS_2			PKG_EVENT+16
	donottranslatetext(TASK_NAME_STRINGS_2, "Event|FTP Server|HTTP Web Server|IMAP Server|Indexer|LDAP Server|MTBFManager|NNTP Server|POP3 Server|Router|Replicator|Schedule Manager|Stats|WEB Retriever|Reporter|SMTPMTA")
...
#define ERR_CONFIG_DB_TIMEOUT		PKG_EVENT+20
	errortext(ERR_CONFIG_DB_TIMEOUT,"Task timed out waiting for Statistic & Event Config database to be created. Please restart task.")

#define ERR_ADDIN_CREATE_CONFIG		PKG_EVENT+21
	errortext(ERR_ADDIN_CREATE_CONFIG,"Creating the Statistics & Events Configuration database.")

#define ERR_ADDIN_NO_CONFIG			PKG_EVENT+22
	errortext(ERR_ADDIN_NO_CONFIG,"Cannot create the Statistics & Events Configuration database.")
