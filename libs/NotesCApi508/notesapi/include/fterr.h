...
#define LOG_FT_SUMM_ERR			PKG_FT+21
...
#define LOG_FT_DOMAIN_INDEX_ERR	PKG_FT+27
	errortext(LOG_FT_DOMAIN_INDEX_ERR, "Error full text indexing document NT%08lx for database %p in domain index %p")
...
#define ERR_FT_FAIL_CREDIR		PKG_FT+49
	errortext(ERR_FT_FAIL_CREDIR,	"Unable to create directory")
/*	More error codes */
