...
STATUS LNPUBLIC		NIFFindByName (HCOLLECTION hCollection, char far *Name, WORD FindFlags,
									COLLECTIONPOSITION far *retIndexPos,
									DWORD far *retNumMatches);

STATUS LNPUBLIC		NIFFindDesignNote (DBHANDLE hFile, char far *Name, WORD Class, NOTEID far *retNoteID);
...
STATUS LNPUBLIC		NIFFindPrivateDesignNote (DBHANDLE hFile, char far *Name, WORD Class, NOTEID far *retNoteID);
...
STATUS LNPUBLIC		NIFFindDesignNoteExt (DBHANDLE hFile, char far *Name, WORD Class, char *pszFlagsPattern, NOTEID far *retNoteID, DWORD Options);
