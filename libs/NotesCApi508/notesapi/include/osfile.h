...
#define FILE_UNIQUETEMP 11		/* DOM - Any .DOM. Used for container and sort temp files to give them a more
								   unique name than .TMP so we can delete *.DOM from the temp directory and
