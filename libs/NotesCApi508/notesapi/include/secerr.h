...
#define ERR_SECURE_PASS_NOT_SAME			PKG_SECURE+236
	errortext(ERR_SECURE_PASS_NOT_SAME, "Your Windows account password does not match your Notes password. To synchronize the passwords, use File - Tools - User ID and click Set Password.")
