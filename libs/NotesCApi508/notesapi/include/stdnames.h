...
#define DESIGN_FLAG_FILE				'g'	/*  FORM: file design element (future) */
#define DESIGN_FLAG_OTHER_DLG			'H'	/*	ALL: Indicates a form that is placed in Other... dialog */
#define DESIGN_FLAG_JAVASCRIPT_LIBRARY  'h' /*  Javascript library. (future) */
...
#define DESIGN_FLAG_CONNECTION_RESOURCE		'k'	/* Data Connection Resource (DCR) for 3rd party database (future) */
...
#define DESIGN_FLAG_MULTILINGUAL_PRESERVE_HIDDEN 'Z' /* ALL: Used to indicate design element was hidden */
											...
											/*	(used with the "!" flag) */
#define DESIGN_FLAG_SERVLET				'z' /*  FILTER: this is a servlet, not an agent!(future) */
...
#define DESIGN_FLAG_STYLESHEET_RESOURCE	'='	/* Style Sheet Resource (SSR) (future) */

#ifndef	SHIMMER_OFF
#define DESIGN_FLAG_WEBHYBRIDDB			'%' /* this is a WebHybridDb design doc i.e. it's  quickPlace data note based design doc that's been converted to a regular design docs */
#endif 
...
#ifndef SHIMMER_OFF
#define DESIGN_FLAGS_SUBCLASS		"UW#yi@GFXstmK%"
#else
#define DESIGN_FLAGS_SUBCLASS		"UW#yi@GFXstmK"
#endif
...
#ifndef SHIMMER_OFF
#define DFLAGPAT_VIEWFORM "-FQMUGXWy#i@0nK%"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_VIEWFORM_MENUABLE "-FQMUGXWy#i@40nK%"	/* display things showable on the menu */
#define DFLAGPAT_VIEWFORM_ALL_VERSIONS "-FQMUGXWy#i@K%" /* display things editable with dialog box; no version filtering (for design) */
#else
#define DFLAGPAT_VIEWFORM "-FQMUGXWy#i@0nK"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_VIEWFORM_MENUABLE "-FQMUGXWy#i@40nK"	/* display things showable on the menu */
#define DFLAGPAT_VIEWFORM_ALL_VERSIONS "-FQMUGXWy#i@K" /* display things editable with dialog box; no version filtering (for design) */
...
/* The agent flags are stored in the new flag so the info is not removed by older Designers when the user edits the agent */
...
#define MAIL_CS_ORGANIZER_ITEM			"Organizer"
#define MAIL_CS_ORGANIZERDOMAIN_ITEM	"OrganizerDomain"
#define MAIL_CS_ALTORGANIZER_ITEM		"AltOrganizer"
#define MAIL_CS_LANGORGANIZER_ITEM	    "$LangOrganizer"
 ...
 * DIIOP process.
 */
#define DIIOP_TCP_PORT					0	
#define DIIOP_TCP_PORT_STATUS    		1
#define DIIOP_SSL_PORT        			2
#define DIIOP_SSL_PORT_STATUS    		3
#define DIIOP_THREADPOOL_SIZE			4
#define DIIOP_HTTP_KEYRING_FILE			5
#define DIIOP_IDLE_MINS_ALLOWED			6

#define DIIOP_ITEM_COUNT	        	7
#define DIIOP_ITEMS              "IIOP_Port\0IIOP_PortStatus\0\
IIOP_SSLPort\0IIOP_SSLStatus\0IIOP_ThreadPoolSize\0HTTP_SSLKeyFile\0\
IIOP_IdleMinsAllowed"

/* Address book - Items used by the Domino back-end objects for security
 * configuration
 */
#define LSBE_ALLOW_ACCESS_LIST			0
#define LSBE_DENY_ACCESS_LIST        	1
#define LSBE_CREATE_DB_LIST          	2
#define LSBE_CREATE_RP_LIST          	3
#define LSBE_BROWSE_FLAG				4
#define LSBE_VIEW						5
/* if COM */
#define LSBE_COM_RESTRICTED_LIST		6
#define LSBE_COM_UNRESTRICTED_LIST		7
/* else if J50 */
#define LSBE_J50_RESTRICTED_LIST		6
#define LSBE_J50_UNRESTRICTED_LIST		7
/* else if IIOP */
#define LSBE_IIOP_RESTRICTED_LIST		6
#define LSBE_IIOP_UNRESTRICTED_LIST		7
#define LSBE_IIOP_TCP_NAME_AND_PASSWD	8
#define LSBE_IIOP_TCP_ANONYMOUS			9
#define LSBE_IIOP_SSL_NAME_AND_PASSWD	10
#define LSBE_IIOP_SSL_ANONYMOUS			11
/* endif */
#define LSBE_HTTP_SESSION_AUTH			12

#define LSBE_SECURITY_ITEM_COUNT		13
#define LSBE_SECURITY_ITEMS			"AllowAccess\0DenyAccess\0CreateAccess\0\
ReplicaAccess\0HTTP_DatabaseBrowsing\0HTTP_AuthView\0\
NOIRestrictedList\0NOIUnrestrictedList\0\
IIOP_TCPNP\0IIOP_AllowAnonymous\0\
IIOP_SSLNP\0IIOP_SSLAnonymous\0HTTP_enableSessionAuth"

#define LTPA_SESSIONAUTH "HTTP_enableSessionAuth"
...
#define ASSIST_RESTRICTED		"$Restricted"/* agent designer can force the agent to have restricted
												   rights, even if the signer has unrestricted rights */
#define ASSIST_RESTRICTED_NOT_FORCED	0		/* used when the restrictions are not forced in the agent */
#define ASSIST_RESTRICTED_NOT_PRESENT   1		/* used when the item is not present in the agent */
#define ASSIST_RESTRICTED_FORCED		1		/* used when the designer wants to force the agent to be only restricted
												   note: this flag has no effect when the agent signer is restricted or
												   has no rights to run the agents */
#define ASSIST_RESTRICTED_FORCED_USED	15		/* set when the flag was used to lower permissions */
