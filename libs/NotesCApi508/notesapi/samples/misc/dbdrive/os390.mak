...
# -W0,DLL,EXPO causes the compiler to produce DLL code and export
#   all the external functions.
CCOPTS = -c $(DEBUG) -W0,DLL,EXPO
...
# -o dbdbdrv causes compiler to create dbdbdrv rather than a.out.
# -Wl,DLL caused the output to be linked as a DLL.  Note that a
#   side-deck, dbdbdrv.x will also be created, but is not needed.
LINKOPTS = $(DEBUG) -o dbdbdrv -Wl,DLL
# Here is how to produce a pre-linker and linker map.    
#LINKOPTS = $(DEBUG) -Wl,p,map -o dbdbdrv -Wl,DLL
