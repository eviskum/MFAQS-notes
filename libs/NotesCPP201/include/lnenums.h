...
enum LNNOTETYPEEXT
{
	...
	LNNOTETYPEEXT_IMAGES,		
	LNNOTETYPEEXT_APPLETS,		
...
#define LNNOTETYPE_FORM						MAKELONG((WORD)NOTE_CLASS_FORM,(WORD)LNNOTETYPEEXT_FORM)
	...
	#define LNNOTETYPE_IMAGES				MAKELONG((WORD)NOTE_CLASS_FORM,(WORD)LNNOTETYPEEXT_IMAGES)
	#define LNNOTETYPE_APPLETS				MAKELONG((WORD)NOTE_CLASS_FORM,(WORD)LNNOTETYPEEXT_APPLETS)
...
// Typo in 4.0 and 4.01 - here for posterity's sake.
#define LNNOTETYPE_NOTIFY_DELETEION			MAKELONG((WORD)NOTE_CLASS_NOTIFYDELETION,(WORD)NOTETYPEEXT_UNKNOWN)
