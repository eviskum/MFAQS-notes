...
LNERRDEF( VIEW_FOLDER_DUPLICATE_NAME, \
	"A view or folder with the specified name already exists" )
...
LNERRDEF( NOT_FORM_NOTE, "This operation can only be performed on a form note" )
...
LNERRDEF( INVALID_BY_FORM_USED_SEARCH,
		 "Specified 'By Form Used' search is invalid" )
