...
ENVIRONMENTS
------------
This program is designed for Microsoft Visual C++ Version 5.0.
...
15.	Set up the build environment if needed and build the button.ocx.
	...
	and adding 'notes.lib' and 'notescpp.lib' to your linker libraries.

16.	To test the OCX with the button.htm file provided you may need
	change the CLASSID in button.htm to match the UUID in button.odl 
	file.
...
button.ocx      - Button ActiveX control.
