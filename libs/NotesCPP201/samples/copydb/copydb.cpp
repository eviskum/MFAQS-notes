...
//					server pathnames, the destination database and server
//					pathnames, and whether to make a replicating or 
//					non-replicating copy.
//		
//		Syntax:
//					COPYDB
//===========================================================================
...
int main(int argc, char *argv[])
{
	...
	try
	{
		...
		cout << endl;
		cout << "Source Database: [" << InDbFile << "] was successfully copied." << endl;
		cout << "The New Database Copy is: [" << OutDbFile << "]" << endl;
		cout << "The New Database Title is: [" << DBTitle << "]" << endl;
