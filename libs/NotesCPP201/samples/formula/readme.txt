...
formula.def  - Module definition (.def) file for 16-bit Borland C++ for Windows.
...
- Under OS/2, Windows NT, Windows 95 and UNIX (Solaris, AIX, OS/390 or HP-UX):
  Type 'formula' at the system command prompt, followed by the Notes
...
1. Before running formula, use Notes to open VIEW.NSF.
...
3. Close VIEW.NSF and run formula.
4. Re-open VIEW.NSF.
5. Re-open the main topic document. The word 'Event' in the subject 
