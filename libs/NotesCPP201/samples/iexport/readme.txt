...
PROGRAM
-------
IEXPORT - Notes C++ API sample program that imports a Microsoft Rich Text
...
impfile.rtf  - Sample RTF file (in NOTEDATA directory).


RUNNING IEXPORT
----------------
This sample program is designed to work with the sample database
sampledb.nsf and the file impfile.rtf, both provided in the toolkit
...
of the server. For example, assuming sampledb.nsf and impfile.rtf have
...
To see if IEXPORT worked correctly:
      ...
      Open the first note. The file impfile.rtf should be imported
