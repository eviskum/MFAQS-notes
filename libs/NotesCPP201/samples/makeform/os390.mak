#
#       Makefile for Notes C++ API sample program ACLLOG
#       Builds the sample MAKEFORM for the OS390 platform
#
...
# -o $TARGET causes compiler to create makeform rather than a.out.
