...
mswin32.mak  - Make file for Windows NT (32-bit, Intel only) and 
...
not apply to either Macintosh, OS/2 or UNIX but works on all other platforms.

- Under OS/2, Windows NT, Windows 95, and UNIX (Solaris, AIX, or HP-UX):
  Type 'makeform' at the system command prompt.
