...
#		Builds the sample RTBUTTON for Win32 platforms
...
#
# NOTE:  Since this sample also makes C API calls, you need to link
#        the NOTES.LIB inport library too.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
.OBJ.EXE:
    $(link) $(linkdebug) $(conflags) -out:$@ $** $(conlibsmt) \
		notescpp.lib notes.lib libcimt.lib
