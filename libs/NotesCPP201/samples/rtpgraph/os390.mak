#
#       Makefile for Notes C++ API sample program RTPGRAPH
#       Builds the sample RTPGRAPH for the OS/390 platform
#
...
# -o $TARGET causes compiler to create dbtitle rather than a.out.
...
# object resolution.
LIBRARY = $(NOTESCPP)/lib/os390/libcppos390$(CPPAPI_ID).x $(Notes_ExecDirectory)/libnotes.x
