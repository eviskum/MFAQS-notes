...
new rich text classes, LNTable and LNTableCell. It creates a new document in a
...
rttable.def  - Module definition (.def) file for 16-bit Borland C++ for 
               Windows.
...
Under Windows 16-bit, choose File - Run from the Program Manager menu, type 
the full program path and filename, add command line arguments (see below)
