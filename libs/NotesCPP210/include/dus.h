...
#if defined(NT) /* This SPI interface only available with Admin Client */
...
#ifdef MAILFILE_NAME_OPTION
	#define fDUSUseMailFileNameProvided	0x00000040	/* use mail file name provided in lieu of generated Notes mail file name */
#endif
