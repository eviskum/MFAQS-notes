...
#if (defined LNCPPAPI_HEADER_VERSION && LNCPPAPI_HEADER_VERSION != 500) || \
...
const LNVERSION LNAPIVERSION = 210;

#define LNAPIVERSIONSTRING "Lotus C++ API Release 2.1 for Domino and Notes 5.0"
