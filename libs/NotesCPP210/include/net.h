...
#define MAX_REMOTE_LAN_SERVICE_NAME 20 	/* DLL Name for Remote Lan Service */
#define MAX_REMOTE_LAN_PARAM_STRING 50	/* For parameter storage. This
										applies to params and param labels. */
