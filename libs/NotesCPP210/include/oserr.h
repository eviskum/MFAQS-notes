...
#ifdef INTL_ENGLISH
	stringtext(STR_OS_DEFAULT_CURRENCYSTRING, "œ")
#else
...
#define ERR_WEB_DOWNLOAD_PROMPT			PKG_OS+227
	errortext(ERR_WEB_DOWNLOAD_PROMPT,	"The feature you have chosen is not available in this trial version of Notes.\nTo access this feature, you will need to install the shipping version of Notes")
#define ERR_WEB_DOWNLOAD_HELP			PKG_OS+228
	errortext(ERR_WEB_DOWNLOAD_HELP,	"Help files not available in this trial version of Notes. To use this feature,\naccess help on a Domino server or the web, or install the shipping version of Notes.")
#define ERR_WEB_DOWNLOAD_SPELL			PKG_OS+229
	errortext(ERR_WEB_DOWNLOAD_SPELL,	"Spelling and dictionary files requested are not available in this trial version of Notes.\nTo access this feature, you will need to install the shipping version of Notes")
