...
#define ERR_CMD_CMD_STOP			PKG_SERVER2+17
	errortext(ERR_CMD_CMD_STOP,		"STOP PORT")
...
#define ERR_HELP_CMD_START				PKG_SERVER2+19
	stringtext(ERR_HELP_CMD_START,	"Starts the specified service")
#define ERR_HELP_CMD_STOP				PKG_SERVER2+20
	stringtext(ERR_HELP_CMD_STOP,	"Stops the specified service")
...
#define	ERR_TASK_DESC_LOADMON		PKG_SERVER3+12
	stringtext(ERR_TASK_DESC_LOADMON, "Load Monitor is updating server load")
#define	ERR_TASK_DESC_LOADMON_IDLE	PKG_SERVER3+13
	stringtext(ERR_TASK_DESC_LOADMON_IDLE, "Load Monitor is idle")
