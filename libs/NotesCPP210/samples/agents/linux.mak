...
LINKOPTS1 = -L$(LNLIBDIR) -o $(TARGET1)
LINKOPTS2 = -L$(LNLIBDIR) -o $(TARGET2)
...
$(TARGET): $(OBJECTS)
	$(LINK) $(LINKOPTS1) $(OBJECTS1) -L$(NOTESDIR) $(LNLIBCPP) $(LIBS)
	$(LINK) $(LINKOPTS2) $(OBJECTS2) -L$(NOTESDIR) $(LNLIBCPP) $(LIBS)
