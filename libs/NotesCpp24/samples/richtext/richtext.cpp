...
int main(int argc, char *argv[])
{
	...
	try 
	{
		...
		//	Changed according to the released note:
		//		The LNDatetimeRanges symbol now maps automatically to LNDatetimes.
		//		Existing applications that use LNDatetimeRanges still work, but new
		//		applications should be written to use LNDatetimes instead.
		LNDatetimes			DatetimeRange, DatetimeRanges;
		LNString			TextString;
		LNRichText			RT, NewRT;
		LNDocument			NewDoc;
