...
int main(int argc, char *argv[])
{
	...
	LNString                logfile;
		...
		//Set the date components of the date/time to July 15th of the current year. 
		//Uses the current time zone.
		LNDatetime  expiration;
		expiration.SetDate(7,15,0);	// can also omit third arg entirely 
									// to specify current year

		//Add two years to date. (By default, 
		//Notes sets certificate expirations to 2 years from the creation date.)
